...
public class ConfigureSwaggerOptions : IConfigureOptions<SwaggerGenOptions>
{
    ...
    public void Configure(SwaggerGenOptions options)
    {
        ...
        // use FullName for schemaId - avoids conflicts between classes using the same name in different namespaces.
        ...
        options.AddSecurityDefinition("Bearer", new OpenApiSecurityScheme()
        {
            Description =
                ...
                "You will get the bearer from the <i>account/login</i> or <i>account/Fregister</i> endpoint.",
            Name = "Authorization",
